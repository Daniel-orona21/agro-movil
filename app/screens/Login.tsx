...
import { View, Text, StyleSheet, TextInput, Button, Modal, TouchableOpacity, ImageBackground, Image } from 'react-native';
...
const styles = StyleSheet.create({
  ...
  emailInput: {
    ...
    color: 'white',
    marginBottom: 10, // Puedes ajustar el margen según tus preferencias
  },
  passwordInput: {
    height: 44,
